...
## Apakah lahan ini sudah dimiliki/dibuka oleh player. Kalau false, lahan
## masih terkunci dan gak muncul di tab Terroir sampai dibeli.
@export var owned: bool = false
## Harga beli untuk membuka lahan ini (kalau owned masih false).
...
# Infrastructure
## Apakah lahan ini sudah memiliki sistem terasering.
@export var has_terracing: bool = false
## Apakah lahan ini sudah memiliki sistem irigasi.
